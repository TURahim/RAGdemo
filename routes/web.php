...
use BookStack\AI\Controllers\AIController;
use BookStack\Api\ApiDocsController;
use BookStack\Api\UserApiTokenController;
use BookStack\App\AssistantController;
use BookStack\App\HomeController;
use BookStack\App\MetaController;
use BookStack\App\SOPDashboardController;
...
Route::middleware('auth')->group(function () {
    ...
    Route::post('/books/{bookSlug}/page/{pageSlug}/revisions/{revId}/submit-review', [EntityControllers\RevisionApprovalController::class, 'submitForReview']);
    Route::get('/books/{bookSlug}/page/{pageSlug}/revisions/{revId}/approve', [EntityControllers\RevisionApprovalController::class, 'showApproveForm']);
    Route::post('/books/{bookSlug}/page/{pageSlug}/revisions/{revId}/approve', [EntityControllers\RevisionApprovalController::class, 'approve']);
    Route::get('/books/{bookSlug}/page/{pageSlug}/revisions/{revId}/reject', [EntityControllers\RevisionApprovalController::class, 'showRejectForm']);
    Route::post('/books/{bookSlug}/page/{pageSlug}/revisions/{revId}/reject', [EntityControllers\RevisionApprovalController::class, 'reject']);
    Route::post('/books/{bookSlug}/page/{pageSlug}/revisions/{revId}/withdraw', [EntityControllers\RevisionApprovalController::class, 'withdrawFromReview']);
    ...
    // SOP Dashboard
    Route::get('/dashboard', [SOPDashboardController::class, 'index']);

    // AI Assistant (full-page chat)
    Route::get('/assistant', [AssistantController::class, 'index']);

    // AI Assistant API (session-authenticated)
    Route::prefix('ai')->group(function () {
        ...
        Route::post('/clear-session', [AIController::class, 'clearSession']);
    });
